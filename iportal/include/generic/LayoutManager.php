...
require_once('iportal/include/generic/SugarWidgets/SugarWidgetSubPanelTopButton.php');
...
class LayoutManager
{
	...
	function getClassFromWidgetDef($widget_def, $use_default = false)
	{
		...
		if(!empty($class_map[$class_name]))
		{
			if (empty($class_map[$class_name]['widget_class'])) {
				...
				if (!class_exists($class_map[$class_name]['widget_class'])) {
					require_once('iportal/include/generic/SugarWidgets/'.$class_map[$class_name]['widget_class'].'.php');
				}
		...
		if(!class_exists($class_name))
		{
			...
			if (file_exists('iportal/include/generic/SugarWidgets/'.$class_name.'.php'))
				require_once('iportal/include/generic/SugarWidgets/'.$class_name.'.php');
