...
class SugarWidgetSubPanelTopCreateCampaignLogEntryButton extends SugarWidgetSubPanelTopButton
{
    function display($widget_data)
    {
        ...
        $return_url = "iportal.php?module=$return_module&action=$return_action&subpanel=$subpanel_name&record=$return_id&sugar_body_only=1";
        ...
        return '<form action="iportal.php?module=CampaignLog&action=AddCampaignLog&type=contact">' . "\n"
