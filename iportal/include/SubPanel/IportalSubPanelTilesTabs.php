...
class IportalSubPanelTilesTabs extends SubPanelTiles
{
    ...
    function applyUserCustomLayoutToTabs($tabs, $key='All')
    {
        ...
        $usersCustomLayout = IportalSubPanelTilesTabs::getSubpanelGroupLayout($key);
	...
	function getTabs($tabs, $showTabs = true, $selectedGroup='All')
    {
    	...
    	$spd = new IportalSubPanelDefinitions ( $this->focus ) ;
        ...
        if($showTabs)
        {
    	    ...
    	    foreach ($groups as $key=>$tab)
    		{
                ...
                if($display)
                {
                    $relevantTabs = IportalSubPanelTilesTabs::applyUserCustomLayoutToTabs($tabs, $key);
        ...
        {
            $tabs = IportalSubPanelTilesTabs::applyUserCustomLayoutToTabs($tabs, $selectedGroup);
