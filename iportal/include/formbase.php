...
function handleRedirect($return_id='', $return_module='')
{
    ...
    {
        header("Location: iportal.php?action=$return_action&module=$return_module&record=$return_id&return_module=$return_module&return_action=$return_action");
    } else {
        ...
        header("Location: iportal.php?{$standard}{$add}");
    }
	exit;
}
