...
class LanguageManager{
	 ...
	 */
     //taras  $refresh = true  - refresh the sugar cache
	function createLanguageFile($module , $templates=array('default'), $refresh = true){
	...
	function refreshLanguage($module, $lang, $loaded_mod_strings = array(), $additional_search_paths = null){
		...
		$lang_paths = array(
                    ...
                    'iportal/modules/'.$module.'/language/'.$lang.'.lang.php',  //taras LOADING A LANGUAGE PACK FROM IPORTAL
