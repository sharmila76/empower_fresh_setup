...
class SugarEmailAddress extends SugarBean {
    ...
    function getEmailAddressWidgetEditView($id, $module, $asMetadata=false, $tpl='',$tabindex='')
    {
        ...
        $this->smarty->assign('emailAddressValue', $prefillDataArr[0]['email_address']);
        ...
        $template = empty($tpl) ? "iportal/include/SugarEmailAddress/templates/forEditView.tpl" : $tpl;
    ...
    function getEmailAddressWidgetWirelessEdit($id, $module, $asMetadata=false)
    {
        ...
        $newEmail = $this->smarty->fetch("iportal/include/SugarEmailAddress/templates/forWirelessEdit.tpl");
    ...
    function getEmailAddressWidgetDetailView($focus, $tpl='')
    {
        ...
        $templateFile = empty($tpl) ? "iportal/include/SugarEmailAddress/templates/forDetailView.tpl" : $tpl;
    ...
    function getEmailAddressWidgetDuplicatesView($focus) 
    {
        ...
        return $this->smarty->fetch("iportal/include/SugarEmailAddress/templates/forDuplicatesView.tpl");
    }
...
function getEmailAddressWidget($focus, $field, $value, $view, $tabindex='') {
    ...
    if($aclAccessLevel > 1) {*/
        if($view == 'IportalEditView' || $view == 'QuickCreate' || $view == 'ConvertLead') {
