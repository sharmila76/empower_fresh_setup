...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	...
	header("Location: iportal.php?module=Accounts&action=index");
}
...
$detailView->local_theme="default";
$detailView->local_app_strings['LBL_EMAIL_ADDRESS_BOOK_TITLE_ICON']="";
$detailView->local_app_strings['LBL_EMAIL_ADDRESS_BOOK_TITLE_ICON_SHORT']="";
$detailView->local_image_path="themes/default/images";
...
echo preg_replace("/<img[^>]+>/", "",getClassicModuleTitle("KBDocuments", $params, false));


$GLOBALS['log']->info("KBDocument detail view");

$xtpl=new XTemplate ('iportal/modules/KBDocuments/DetailView.html');
...
$xtpl->assign("PRINT_URL", "iportal.php?".$GLOBALS['request_string']);
