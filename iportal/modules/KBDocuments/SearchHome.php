 ...
 */
require_once('iportal/modules/KBDocuments/SearchUtils.php');

global $mod_strings, $app_strings;
global $current_language;

if(file_exists('iportal/modules/KBDocuments/language/'.$current_language.'.lang.php')){
    include('iportal/modules/KBDocuments/language/'.$current_language.'.lang.php');
}
...
////////////////////////////////// Browse Section ///////////////////////////////////////
    ...
    <script language='JavaScript' src='iportal/include/ytree/treeutil.js'></script>
...
///////////////////////////////////////////////////////////////////////////////////////////////
    //display results
    $ss->display("iportal/modules/KBDocuments/SearchHome.html");
...
function perform_advanced_search($focus,$default=false){
    ...
    function return_browse_tab(){
        ...
        require_once('iportal/modules/KBTags/TreeData.php');
       ...
       if(empty($tagstree->_nodes)){
        ...
        return $ss_brws->fetch("iportal/modules/KBDocuments/tpls/browseTab.tpl");
}
    ...
    function return_advanced_tab($focus,$json, $json_config){
        ...
        $ss_adv->assign("PRINT_URL", "iportal.php?".$GLOBALS['request_string']);
    ...
    echo $str;
        ...
        $ss_adv->assign('JSON_CONFIG_JAVASCRIPT', $json_config->get_static_json_server());
            ...
            return $ss_adv->fetch("iportal/modules/KBDocuments/tpls/advancedTab.tpl");
}
  ...
  return preg_replace($tag_regex,"",$xml);
}
