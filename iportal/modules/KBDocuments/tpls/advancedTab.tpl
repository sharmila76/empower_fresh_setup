...
<form enctype="multipart/form-data" id="FTSFormAdvanced" name="FTSFormAdvanced" method="POST" action="iportal.php">
				...
				<div id='more_options_div' name='more_options_div' style='display: none'>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td valign="top" scope="row"><span sugar='slot5'>&nbsp;</span sugar='slot'></td>
							<td ><span sugar='slot5b'>&nbsp;</span sugar='slot'>
							</td>
						</tr>
