...
require_once('iportal/include/IportalSearchForm/IportalSearchForm.php');
...
$lv->setup($seedCase, 'iportal/include/IportalListView/IportalListViewGeneric.tpl', $where, $params);
