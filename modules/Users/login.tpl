            ...
            <div class="loginBoxShadow" style="width: 460px;">
                <div class="loginBox">
                    <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">			    
                        ...
                        <tr>
                            <td>
                                <div class="center"><b style="font-size: 20px;">{sugar_translate module="Users" label=Welcome}</b>					
                                    <br>
                                    <u><span style="font-size: 14px; font-weight:bold; color:#800000; font-family:Eras Demi ITC;">{sugar_translate module="Users" label="Empower CSI  Inc. - CRM"}</span></u></div>
                                    ...
                                    <form action="index.php" method="post" name="DetailView" id="form" onsubmit="return document.getElementById('cant_login').value == ''">
                                        <table cellpadding="0" cellspacing="2" border="0" align="center">
                                            ...
                                            <tr>
                                                ...
                                                <td width="70%"><input type="text" size='35' tabindex="1" id="user_name" placeholder="Enter User Name" name="user_name"  value='{$LOGIN_USER_NAME}' /></td>												
                                            </tr>
                                            <tr><td><br></td></tr>
                                            <tr>
                                                <td scope="row"><label for="user_password">{sugar_translate module="Users" label="LBL_PASSWORD"}:</label></td>
                                                <td width="30%"><input type="password" size='26' tabindex="2" placeholder="Enter Password" id="user_password" name="user_password" value='{$LOGIN_PASSWORD}' /></td>
                                            </tr>
                                            <tr><td><br></td></tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td><input title="{sugar_translate module="Users" label="LBL_LOGIN_BUTTON_TITLE"}" type="submit" tabindex="3" id="login_button" name="Login" value="{sugar_translate module="Users" label="LBL_LOGIN_BUTTON_LABEL"}"><br>&nbsp;</td>
                                            </tr>
                                        </table>
                                    </form>
                                    ...
                                    <div id="forgot_password_dialog" style="display:none" >
                                        ...
                                        <table cellpadding="0" cellspacing="2" border="0" align="center">
                                            ...
                                            <tr>
                                                ...
                                                <td width="70%"><input type="text" size='26' placeholder="Enter User Name" id="fp_user_name" name="fp_user_name"  value='{$LOGIN_USER_NAME}' /></td>
                                            </tr>
                                            <tr><td><br></td></tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="70%"><input title="Email Temp Password" class="button" type="button" style="display:inline" onclick="validateAndSubmit();
                                                        return document.getElementById('cant_login').value == ''" id="generate_pwd_button" name="fp_login" value="{sugar_translate module="Users" label="LBL_LOGIN_SUBMIT"}"></td>
                                            </tr>
