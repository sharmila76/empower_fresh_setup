 ...
 * PLACE ANY CUSTOMIZATIONS IN OSS_TeamMember
 */

require_once('include/SugarObjects/templates/person/Person.php');

class OSS_TeamMember_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'OSS_TeamMember';
	var $object_name = 'OSS_TeamMember';
	var $table_name = 'oss_teammember';
	var $importable = true;
		...
		var $landline_no;
		var $designation;
		var $permanent_landline;
		var $current_landline;
		var $officialdob;
		var $actualdob;
		var $spousename;
		var $spousedob;
