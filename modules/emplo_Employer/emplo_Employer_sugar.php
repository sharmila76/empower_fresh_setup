 ...
 * PLACE ANY CUSTOMIZATIONS IN emplo_Employer
 */

require_once('include/SugarObjects/templates/company/Company.php');

class emplo_Employer_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'emplo_Employer';
	var $object_name = 'emplo_Employer';
	var $table_name = 'emplo_employer';
	var $importable = true;
