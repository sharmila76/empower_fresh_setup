...
class OBJ_Indicators_SubPanelTiles extends SubPanelTiles {

	function OBJ_Indicators_SubPanelTiles(&$focus, $layout_def_key='', $layout_def_override = '') {
...
EOQ;
            ...
            if($div_display != 'none'){
            	...
            	include_once('modules/OBJ_Indicators/views/OBJ_Conditions_ListView.php');
            	$subpanel_object = new SubPanel($this->module, $_REQUEST['record'], $tab,$thisPanel,$layout_def_key);
            	$subpanel_object->listview = new OBJ_Conditions_ListView();
