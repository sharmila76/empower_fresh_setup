function show_period_numbers(field) {
	for (targetFieldName in periodNumberDefs[field.name][field.value]) {
		...
		var newDropdownOptions = SUGAR.language.get('app_list_strings', periodNumberDefs[field.name][field.value][targetFieldName]);
