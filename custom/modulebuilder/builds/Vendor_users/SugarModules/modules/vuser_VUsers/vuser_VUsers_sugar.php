 ...
 * PLACE ANY CUSTOMIZATIONS IN vuser_VUsers
 */

require_once('include/SugarObjects/templates/person/Person.php');

class vuser_VUsers_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'vuser_VUsers';
	var $object_name = 'vuser_VUsers';
	var $table_name = 'vuser_vusers';
