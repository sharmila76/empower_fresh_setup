...
//Taras: fixed problem with current theme
...
if (!empty($modulename) && !empty($func_name) && isset($beanList[$modulename]) ) {
  //Taras: include the TreeData.php in Iportal first
    if (file_exists('iportal/modules/'.$modulename.'/TreeData.php')) {
       require_once('iportal/modules/'.$modulename.'/TreeData.php');
    }
    else {
