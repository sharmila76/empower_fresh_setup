<?php 
 $GLOBALS["dictionary"]["HRM_Holydays"]=array (
  'table' => 'hrm_holydays',
  'audited' => true,
  'fields' => 
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hrm_holydays_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hrm_holydays_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'hrm_holydays_assigned_user',
...
echo &quot;&lt;/DIV&gt;&quot;;',
    ...
    array (
      ...
      'type' => 'relate',
      'source' => 'non-db',
      'vname' => 'LBL_HRM_EMPLOYEES_HRM_HOLYDAYS_FROM_HRM_EMPLOYEES_TITLE',
      'save' => true,
      'id_name' => 'hrm_employe_employees_ida',
      'link' => 'hrm_employees_hrm_holydays',
      'table' => 'hrm_employees',
