<?php /* Smarty version 2.6.11, created on 2014-04-15 12:47:32
         compiled from modules/Timesheet/Addpackage.html */ ?>
<form method="POST" action="index.php">
    <input type="hidden" name="module" value="Timesheet">
    <input type="hidden" name="action" value="Addpackage">
    <input type="hidden" name="return_module" value="Timesheet">
