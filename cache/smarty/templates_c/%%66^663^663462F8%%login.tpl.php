...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/Users/login.tpl', 42, false),array('function', 'sugar_getimagepath', 'modules/Users/login.tpl', 142, false),)), $this); ?>
<!--
/*********************************************************************************
...
<table cellpadding="0" align="center" cellspacing="0" border="0" style="margin-top: 30px; width="100%"">
    <tr>
        <td align="center">
            <div class="loginBoxShadow" style="width: 460px;">
                <div class="loginBox">
                    <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">			    
                        <tr>					
                            <td align="left" class="loginBox_image"><img width="100" style="margin: 5px 0; padding-left: 5px;" alt="Sugar" src="include/images/sugar_md_open.png"><br>					
                            </td>					
                        </tr>				
                        <tr>
                            <td>
                                <div class="center"><b style="font-size: 20px;"><?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'Welcome'), $this);?>
</b>					
                                    <br>
                                    <u><span style="font-size: 14px; font-weight:bold; color:#800000; font-family:Eras Demi ITC;"><?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => "Empower CSI  Inc. - CRM"), $this);?>
</span></u></div>
                                <div class="key" style="float: right;"><img height="40" width="50" style="margin: 5px 0;" alt="Sugar" src="include/images/loginkey.png"></div><br>
                            </td>
                        </tr>				
                        <tr>
                            <td>
...
:</label></td>
                                                <td width="70%"><input type="text" size='35' tabindex="1" id="user_name" placeholder="Enter User Name" name="user_name"  value='<?php echo $this->_tpl_vars['LOGIN_USER_NAME']; ?>
' /></td>												
                                            </tr>
                                            <tr><td><br></td></tr>
                                            <tr>
...
:</label></td>
                                                <td width="30%"><input type="password" size='26' tabindex="2" placeholder="Enter Password" id="user_password" name="user_password" value='<?php echo $this->_tpl_vars['LOGIN_PASSWORD']; ?>
' /></td>
                                            </tr>
                                            <tr><td><br></td></tr>
                                            <tr>
...
" type="submit" tabindex="3" id="login_button" name="Login" value="<?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_LOGIN_BUTTON_LABEL'), $this);?>
"><br>&nbsp;</td>
                                            </tr>
                                        </table>
                                    </form>
...
:</label></td>
                                                <td width="70%"><input type="text" size='26' placeholder="Enter User Name" id="fp_user_name" name="fp_user_name"  value='<?php echo $this->_tpl_vars['LOGIN_USER_NAME']; ?>
' /></td>
                                            </tr>
                                            <tr><td><br></td></tr>
                                            <tr>
...
:</label></td>
                                                <td width="70%"><input type="text" size='26' placeholder="Enter Email Address" id="fp_user_mail" name="fp_user_mail"  value='' ></td>
                                            </tr>
                                            <tr><td><br></td></tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="70%"><input title="Email Temp Password" class="button" type="button" style="display:inline" onclick="validateAndSubmit();
                                                        return document.getElementById('cant_login').value == ''" id="generate_pwd_button" name="fp_login" value="<?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_LOGIN_SUBMIT'), $this);?>
"></td>
                                            </tr>
