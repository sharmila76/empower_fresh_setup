<?php /* Smarty version 2.6.11, created on 2014-04-18 12:31:40
         compiled from modules/Eval_Evaluations/Addmultiplechoice.html */ ?>
<form name="EditView" method="GET" action="index.php">
<input type="hidden" name="module" value="Eval_Evaluations">
<input type="hidden" name="action" value="Addmultiplechoice">
