...
require('iportal/include/utils/autoloader.php');
spl_autoload_register(array('IportalAutoLoader', 'autoload'));
require_once('data/SugarBean.php');
require_once('include/utils/mvc_utils.php');
require('iportal/include/SugarObjects/LanguageManager.php');  //taras changed to iportal
...
require_once('iportal/include/SugarEmailAddress/SugarEmailAddress.php');    //Changed loading EmailAddress to iportal
require_once('include/SugarLogger/LoggerManager.php');
require_once('modules/Trackers/BreadCrumbStack.php');
require_once('modules/Trackers/Tracker.php');
require_once('modules/Trackers/TrackerManager.php');
require_once('iportal/modules/ACL/ACLController.php');
